export default function WorkbookCard({ wb, onClick }) {
  ...
  return (
    <div className="card wb-card glow" onClick={() => onClick?.(wb)}>
      <div style={{ marginBottom: 12, color: 'var(--green)' }}><svg className="icon icon-lg" viewBox="0 0 24 24"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg></div>
