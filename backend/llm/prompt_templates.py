...
def build_user_message(
    ...
    parts += [
        ...
        "- For Name fields (e.g., website_name, company_name, name): extract the entity's actual brand/person/company name (e.g., 'LinkedIn', 'BP', 'Acme Corp'). NEVER put a URL into a name field.",
        "- For URL fields (e.g., website_url, url, link): extract the web address. Use the 'Current page URL' provided above if no explicit external link is mentioned.",
        ...
        "  a short label like 'Professional Networking & Career Services' or 'Chemical Manufacturing'.",
